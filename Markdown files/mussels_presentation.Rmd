...
abundance_data2 <- select(abundance_data,
                          c(ï..site,
                            georegion,
...
```{r, echo=FALSE}
kable(abundance_table, col.names = c('Site', 'Region', 'Mussel Mean % Cover (Pre)',
      'Mussel Mean % Cover (Post)', 'Mean Pisaster Density (Pre)',
      'Mean Pisaster Density (Post)'))
