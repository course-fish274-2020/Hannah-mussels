...
This project seeks to compare the abundance of sea star "Pisaster ochraceus" and local mussels species in Western US rocky intertidal zones before and after an occurrence of Sea Star Wasting Syndrome (SSWS) causes mass sea star mortality. 
...
```{r, echo=FALSE}
kable(abundance_table, col.names = c('Site', 'Region', 'Time Relative to SSWS',
                                     'Mussel Mean Percent Cover', 'Pisaster Mean Density'))
```
## Comparing Pisaster density to Mussel percent cover

```{r, message = FALSE, warning = FALSE, echo = FALSE}
ggplot(abundance_data2, aes(x = Mussel_Cover, y = Pisaster_Density, color = Relative_Time)) +
  geom_point() + scale_x_log10() + scale_y_log10() +
  geom_smooth(method = "lm", se = FALSE) +
  labs(color = "Time Relative to SSWS") +
  xlab("Mean Percent Cover of Mussels") +
  ylab("Mean Density of Pisaster")
...
ggplot(abundance_data2, aes(x = Mussel_Cover, fill = Relative_Time)) +
  ...
  labs(fill = "Time Relative to SSWS") + theme_bw() +
