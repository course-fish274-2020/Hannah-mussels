...
ggplot(abundance_data2, aes(x = Mussel_Cover, y = Pisaster_Density, color = Relative_Time)) +
  ...
  geom_smooth(method = "lm", se = FALSE) + labs(color = "Time Relative to SSWS") +
  xlab("Mean Percent Cover of Mussels") + ylab("Mean Density of Pisaster")
